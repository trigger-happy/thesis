...
\begin{itemize}
 \item Graphics Processing Unit (GPU) -  A Graphics Processing Unit or GPU is special type
...
of the game (eg: not getting killed, obtaining the highest score possible, etc).
\end{itemize}